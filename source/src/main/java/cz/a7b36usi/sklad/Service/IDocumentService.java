...
public interface IDocumentService {
	 ...
	 * 
	 * @param documentId
	 *            identifier of document to be removed
	 */
	 ...
	 * 
	 * @param movementId
	 *            identifier of movement to be removed
	 */
	 ...
	 * 
	 * @param documentId
	 *            identifier of document to be retrieved
	 * @return documentDTO representing data from document with specified
	 *         identifier
	 */
	 ...
	 * 
	 * @param documentId
	 *            identifier of document whose movements will be retrieved
	 ...
	 * 
	 * @param partnerId
	 *            identifier of partner whose documents will be retrieved
	 * @return all movements associated with particular document
	 */
	 ...
	 * 
	 * @param productId
	 *            identifier of product whose movements will be retrieved
