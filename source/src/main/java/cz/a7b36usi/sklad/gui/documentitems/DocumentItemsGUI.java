 ...
 */
@Component
public class DocumentItemsGUI extends javax.swing.JDialog implements IDocumentItemsGUI{
	...
	try {
	    ...
	    java.util.logging.Logger.getLogger(DocumentItemsGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
	...
	java.awt.EventQueue.invokeLater(new Runnable() {
	    public void run() {
		DocumentItemsGUI dialog = new DocumentItemsGUI(new javax.swing.JFrame(), true);
